...
urlpatterns=[
    ...
    path('fitnesscenter/<int:pk>/',views.FitnesscenterDetailView.as_view(),name="fitnesscenter"),
    path('update/customer/<int:pk>/',views.CustomerUpdateView,name="customer_update"),
    path('update/fitnesscenter/<int:pk>/',views.FitnessCenterUpdateView,name="fitnesscenter_update"),
